...
sequenceDiagram
    ...
    browser->>server: GET https://studies.cs.helsinki.fi/49022aa2-bb37-4445-9467-42a8342ebb57
    activate server
    ...
    activate server
    server-->>browser: Json Data -  [{content: "wassup", date: "2024-07-18T08:54:38.009Z"}, ...]
    deactivate server
